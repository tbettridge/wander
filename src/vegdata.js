...
export const RECIPES = {
  ...
  beach:     { density: 0.025, mix: [['palm', 0.7], ['dryshrub', 0.3]] },
...
export const GRASS_COLORS = {
  ...
  beach: [0.6, 0.6, 0.35], desert: [0.6, 0.55, 0.3],
};
export const GRASS_DENSITY = {
  grassland: 1.0, forest: 0.7, jungle: 0.8, savanna: 0.75,
  taiga: 0.4, tundra: 0.25, beach: 0.06, desert: 0.04,
};
...
export const CLUTTER_RECIPES = {
  ...
  beach:     { density: 0.55, mix: [['pebble', 0.52], ['driftwood', 0.32], ['snag', 0.16]] },
