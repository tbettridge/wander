...
assert.match(mainSource, /from '\.\/stationkeeper\.js\?v=groupchat1'/);
assert.match(stationkeeperSource, /from '\.\/npcmemory\.mjs\?v=groupchat1'/);
...
assert.match(mainSource, /from '\.\/livingworld\.mjs\?v=groupchat1'/);
